            ...
            <div className={loading ?
                ...
                <div className="max-w-screen-lg w-full flex flex-col items-center justify-center">
                    ...
                    <div className="mt-6 w-full flex flex-row items-center justify-center gap-5">
                        <Link to='/blogs' className="w-[50%] flex justify-center items-center">
                            <button className="w-full py-3 bg-slate-200 text-gray-800 rounded-lg cursor-pointer text-lg font-bold hover:bg-slate-300 transition-smooth duration-200">
                                Cancel
                            </button>
                        </Link>
                        <button
